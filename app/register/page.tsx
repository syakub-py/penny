                            ...
                            <form className="p-6 md:p-8" onSubmit={handleSubmit}>
                                <div className="flex flex-col gap-6">
                                    <div className="flex flex-col items-center text-center">
                                        ...
                                        <h1 className="text-2xl font-bold text-emerald-950 dark:text-emerald-50">Create your account</h1>
                                        <p className="text-balance text-emerald-700 dark:text-emerald-300">Sign up for your Penny Assistant account</p>
                                    </div>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="grid gap-2">
                                            <Label htmlFor="first_name" className="text-emerald-900 dark:text-emerald-200">First Name</Label>
                                            <Input
                                                id="first_name"
                                                type="text"
                                                placeholder="John"
                                        ...
                                        <div className="grid gap-2">
                                            <Label htmlFor="last_name" className="text-emerald-900 dark:text-emerald-200">Last Name</Label>
                                            <Input
                                                id="last_name"
                                                type="text"
                                                placeholder="Doe"
